...
import com.lg.itemdecoration.draw.DrawDividerLine;
...
public class LinearRecyclerWithDividerLineActivity extends AppCompatActivity {
                ...
                new CommonItemDecoration.Builder()
                        .setItemOffsetsStrategy(
                                new EqualInnerSpaOffsetStrategy
                                        ...
                                        .build())
                        .setIDraw(new DrawDividerLine(R.color.colorAccent, 10))
                        .build());
